...
int main() {
    ...
    try {
#endif
        typedef nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<100>,
                                                     nil::crypto3::multiprecision::et_on>
            big_type1;
        typedef nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<50>,
                                                     nil::crypto3::multiprecision::et_on>
            small_type1;
        typedef nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<100>,
