...
void test_matrix() {
    ...
    test_my_matrix<ublas::matrix<boost::numeric::interval<mp_test_type>, ublas::row_major,
    ...
    test_my_matrix<ublas::matrix<boost::numeric::interval<double>, ublas::row_major,
...
#ifdef USE_FLOAT
    std::cout << "boost::numeric::interval<mp_test_type>, bounded_array" << std::endl;
    test_my_matrix<ublas::vector_of_vector<
...
#ifdef USE_FLOAT
    std::cout << "boost::numeric::interval<mp_test_type>, std::vector" << std::endl;
    test_my_matrix<ublas::vector_of_vector<boost::numeric::interval<mp_test_type>, ublas::row_major,
...
#ifdef USE_DOUBLE
    std::cout << "boost::numeric::interval<double>, std::vector" << std::endl;
    test_my_matrix<ublas::vector_of_vector<boost::numeric::interval<double>, ublas::row_major,
