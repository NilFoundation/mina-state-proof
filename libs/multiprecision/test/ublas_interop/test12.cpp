...
void test_matrix_vector() {
    ...
    test_my_matrix_vector<ublas::vector<mp_test_type, ublas::bounded_array<mp_test_type, 3>>,
                          ublas::matrix<mp_test_type, ublas::row_major, ublas::bounded_array<mp_test_type, 3 * 3>>,
                          3>()();
#endif
    ...
    test_my_matrix_vector<
        ...
        ublas::matrix<std::complex<mp_test_type>, ublas::row_major,
    ...
    test_my_matrix_vector<
        ublas::vector<std::complex<mp_test_type>, ublas::unbounded_array<std::complex<mp_test_type>>>,
    ...
    test_my_matrix_vector<ublas::vector<std::complex<double>, std::vector<std::complex<double>>>,
                          ublas::matrix<std::complex<double>, ublas::row_major, std::vector<std::complex<double>>>,
                          3>()();
#endif
#endif
#endif
    ...
    test_my_matrix_vector<ublas::bounded_vector<mp_test_type, 3>, ublas::bounded_matrix<mp_test_type, 3, 3>, 3>()();
#endif

#ifdef USE_DOUBLE
    std::cout << "double, bounded" << std::endl;
    test_my_matrix_vector<ublas::bounded_vector<double, 3>, ublas::bounded_matrix<double, 3, 3>, 3>()();
#endif
    ...
    std::cout << "mp_test_type, bounded_array" << std::endl;
    test_my_matrix_vector<ublas::vector<mp_test_type, ublas::bounded_array<mp_test_type, 3>>,
                          ublas::vector_of_vector<mp_test_type, ublas::row_major,
    ...
    test_my_matrix_vector<
        ublas::vector<std::complex<double>, ublas::bounded_array<std::complex<double>, 3>>,
        ublas::vector_of_vector<std::complex<double>, ublas::row_major,
    ...
    std::cout << "double, unbounded_array" << std::endl;
    test_my_matrix_vector<
        ublas::vector<double, ublas::unbounded_array<double>>,
    ...
    std::cout << "mp_test_type, std::vector" << std::endl;
    test_my_matrix_vector<
        ublas::vector<mp_test_type, std::vector<mp_test_type>>,
