...
void test_matrix_vector() {
    ...
    test_my_matrix_vector<
        ublas::mapped_vector<std::complex<mp_test_type>, ublas::map_array<std::size_t, std::complex<mp_test_type>>>,
        ublas::mapped_matrix<std::complex<mp_test_type>, ublas::row_major,
    ...
    test_my_matrix_vector<
        ...
        ublas::mapped_matrix<std::complex<double>, ublas::row_major,
    ...
    test_my_matrix_vector<ublas::mapped_vector<mp_test_type, std::map<std::size_t, mp_test_type>>,
                          ublas::mapped_matrix<mp_test_type, ublas::row_major, std::map<std::size_t, mp_test_type>>,
                          3>()();
#endif
    ...
    test_my_matrix_vector<
        ublas::mapped_vector<mp_test_type, ublas::map_array<std::size_t, mp_test_type>>,
        ublas::mapped_vector<mp_test_type, ublas::row_major,
                             ublas::map_array<std::size_t, ublas::map_array<std::size_t, mp_test_type>>>,
        3>()();
#endif
    ...
    test_my_matrix_vector<ublas::mapped_vector<double, ublas::map_array<std::size_t, double>>,
                          ublas::mapped_vector<double, ublas::row_major,
                                               ublas::map_array<std::size_t, ublas::map_array<std::size_t, double>>>,
                          3>()();
#endif
    ...
    test_my_matrix_vector<
        ublas::mapped_vector<std::complex<mp_test_type>, ublas::map_array<std::size_t, std::complex<mp_test_type>>>,
        ublas::mapped_vector<std::complex<mp_test_type>, ublas::row_major,
    ...
    test_my_matrix_vector<
        ublas::mapped_vector<std::complex<double>, ublas::map_array<std::size_t, std::complex<double>>>,
        ublas::mapped_vector<std::complex<double>, ublas::row_major,
    ...
    test_my_matrix_vector<
        ublas::mapped_vector<double, std::map<std::size_t, double>>,
    ...
    test_my_matrix_vector<ublas::compressed_vector<mp_test_type>, ublas::compressed_matrix<mp_test_type>, 3>()();
#endif

#ifdef USE_DOUBLE
    std::cout << "double compressed" << std::endl;
    test_my_matrix_vector<ublas::compressed_vector<double>, ublas::compressed_matrix<double>, 3>()();
#endif
    ...
    test_my_matrix_vector<ublas::coordinate_vector<mp_test_type>, ublas::coordinate_matrix<mp_test_type>, 3>()();
#endif

#ifdef USE_DOUBLE
    std::cout << "double coordinate" << std::endl;
    test_my_matrix_vector<ublas::coordinate_vector<double>, ublas::coordinate_matrix<double>, 3>()();
#endif
