...
#ifdef USE_RANGE
        ublas::vector_range<V> vr1(v1, ublas::range(0, N)), vr2(v2, ublas::range(0, N)), vr3(v3, ublas::range(0, N));
...
void test_vector() {
    ...
    test_my_vector<ublas::vector<std::complex<mp_test_type>, ublas::bounded_array<std::complex<mp_test_type>, 3>>,
                   3>()();
#endif
    ...
    test_my_vector<ublas::vector<std::complex<mp_test_type>, ublas::unbounded_array<std::complex<mp_test_type>>>,
                   3>()();
#endif
