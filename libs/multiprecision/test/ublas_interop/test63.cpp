    ...
    void operator()() const {
...
#ifdef USE_ADAPTOR
        {
            ...
            ublas::matrix_range<ublas::symmetric_adaptor<M>> mr1(sam1, ublas::range(0, N), ublas::range(0, N)),
                mr2(sam2, ublas::range(0, N), ublas::range(0, N)), mr3(sam3, ublas::range(0, N), ublas::range(0, N));
            test_with(mr1, mr2, mr3);
#endif
...
void test_matrix() {
    ...
    test_my_matrix<ublas::symmetric_matrix<mp_test_type, ublas::lower, ublas::row_major,
                                           ublas::bounded_array<mp_test_type, 3 * 3>>,
                   3>()();
#endif

#ifdef USE_DOUBLE
    std::cout << "double, bounded_array" << std::endl;
    test_my_matrix<ublas::symmetric_matrix<double, ublas::lower, ublas::row_major, ublas::bounded_array<double, 3 * 3>>,
                   3>()();
#endif
    ...
    test_my_matrix<ublas::symmetric_matrix<std::complex<mp_test_type>, ublas::lower, ublas::row_major,
    ...
    test_my_matrix<ublas::symmetric_matrix<std::complex<double>, ublas::lower, ublas::row_major,
    ...
    test_my_matrix<
        ublas::symmetric_matrix<mp_test_type, ublas::lower, ublas::row_major, ublas::unbounded_array<mp_test_type>>,
        3>()();
#endif

#ifdef USE_DOUBLE
    std::cout << "double, unbounded_array" << std::endl;
    test_my_matrix<ublas::symmetric_matrix<double, ublas::lower, ublas::row_major, ublas::unbounded_array<double>>,
                   3>()();
#endif
    ...
    test_my_matrix<ublas::symmetric_matrix<mp_test_type, ublas::lower, ublas::row_major, std::vector<mp_test_type>>,
                   3>()();
#endif
    ...
    test_my_matrix<ublas::symmetric_matrix<std::complex<mp_test_type>, ublas::lower, ublas::row_major,
                                           std::vector<std::complex<mp_test_type>>>,
                   3>()();
#endif
