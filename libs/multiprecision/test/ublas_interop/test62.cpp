...
#ifdef USE_SLICE
            ublas::matrix_vector_slice<ublas::symmetric_adaptor<M>> mvs1(tam1, ublas::slice(0, 1, N),
                                                                         ublas::slice(0, 1, N)),
...
void test_matrix_vector() {
    ...
    test_my_matrix_vector<ublas::vector<mp_test_type, ublas::bounded_array<mp_test_type, 3>>,
                          ublas::symmetric_matrix<mp_test_type, ublas::lower, ublas::row_major,
    ...
    test_my_matrix_vector<
        ...
        ublas::symmetric_matrix<std::complex<mp_test_type>, ublas::lower, ublas::row_major,
    ...
    test_my_matrix_vector<ublas::vector<std::complex<double>, ublas::bounded_array<std::complex<double>, 3>>,
                          ublas::symmetric_matrix<std::complex<double>, ublas::lower, ublas::row_major,
