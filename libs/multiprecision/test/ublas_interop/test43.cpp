    ...
    void operator()() const {
...
#ifdef USE_ADAPTOR
        {
            ...
            ublas::matrix_range<ublas::banded_adaptor<M>> mr1(bam1, ublas::range(0, N), ublas::range(0, N)),
                mr2(bam2, ublas::range(0, N), ublas::range(0, N)), mr3(bam3, ublas::range(0, N), ublas::range(0, N));
            test_with(mr1, mr2, mr3);
#endif
            ...
            ublas::matrix_range<ublas::diagonal_adaptor<M>> mr1(dam1, ublas::range(0, N), ublas::range(0, N)),
                mr2(dam2, ublas::range(0, N), ublas::range(0, N)), mr3(dam3, ublas::range(0, N), ublas::range(0, N));
            test_with(mr1, mr2, mr3);
#endif
...
void test_matrix() {
    ...
    test_my_matrix<ublas::banded_matrix<mp_test_type, ublas::row_major, ublas::bounded_array<mp_test_type, 3 * 3>>,
                   3>()();
#endif
    ...
    test_my_matrix<ublas::banded_matrix<std::complex<mp_test_type>, ublas::row_major,
    ...
    test_my_matrix<ublas::banded_matrix<std::complex<double>, ublas::row_major, std::vector<std::complex<double>>>,
                   3>()();
#endif
#endif
#endif
...
#ifdef USE_FLOAT
    std::cout << "mp_test_type, bounded_array" << std::endl;
    test_my_matrix<ublas::diagonal_matrix<mp_test_type, ublas::row_major, ublas::bounded_array<mp_test_type, 3 * 3>>,
                   3>()();
#endif
...
#ifdef USE_FLOAT
    std::cout << "std::complex<mp_test_type>, bounded_array" << std::endl;
    test_my_matrix<ublas::diagonal_matrix<std::complex<mp_test_type>, ublas::row_major,
                                          ublas::bounded_array<std::complex<mp_test_type>, 3 * 3>>,
                   3>()();
#endif
...
#ifdef USE_DOUBLE
    std::cout << "std::complex<double>, bounded_array" << std::endl;
    test_my_matrix<ublas::diagonal_matrix<std::complex<double>, ublas::row_major,
...
#ifdef USE_DOUBLE
    std::cout << "std::complex<double>, std::vector" << std::endl;
    test_my_matrix<ublas::diagonal_matrix<std::complex<double>, ublas::row_major, std::vector<std::complex<double>>>,
                   3>()();
#endif
#endif
#endif
