    ...
    void operator()() const {
...
#ifdef USE_ADAPTOR
        {
            ...
            ublas::matrix_range<ublas::triangular_adaptor<M>> mr1(tam1, ublas::range(0, N), ublas::range(0, N)),
                mr2(tam2, ublas::range(0, N), ublas::range(0, N)), mr3(tam3, ublas::range(0, N), ublas::range(0, N));
            test_with(mr1, mr2, mr3);
#endif
...
void test_matrix() {
    ...
    test_my_matrix<ublas::triangular_matrix<mp_test_type, ublas::lower, ublas::row_major,
    ...
    test_my_matrix<ublas::triangular_matrix<std::complex<mp_test_type>, ublas::lower, ublas::row_major,
    ...
    test_my_matrix<ublas::triangular_matrix<std::complex<double>, ublas::lower, ublas::row_major,
    ...
    test_my_matrix<ublas::triangular_matrix<double, ublas::lower, ublas::row_major, ublas::unbounded_array<double>>,
                   3>()();
#endif
    ...
    test_my_matrix<ublas::triangular_matrix<mp_test_type, ublas::lower, ublas::row_major, std::vector<mp_test_type>>,
                   3>()();
#endif
