...
static bool round_test_imp() {
    typedef nil::crypto3::multiprecision::cpp_dec_float<N> mp_backend_type;
    typedef nil::crypto3::multiprecision::number<mp_backend_type, nil::crypto3::multiprecision::et_off> mp_type;
