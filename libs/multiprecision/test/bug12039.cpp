...
int main() {
    typedef nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::backends::cpp_bin_float<256>>
        ext_float_t;
    typedef nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::backends::cpp_bin_float<2046>>
        long_ext_float_t;
