    ...
    namespace numeric {
        namespace ublas {
            ...
            struct promote_traits<nil::crypto3::multiprecision::number<Backend1, ExpressionTemplates1>,
                ...
                using number1_t = nil::crypto3::multiprecision::number<Backend1, ExpressionTemplates1>;
                using number2_t = nil::crypto3::multiprecision::number<Backend2, ExpressionTemplates2>;
                using promote_type = typename std::conditional<std::is_convertible<number1_t, number2_t>::value &&
                                                                   !std::is_convertible<number2_t, number1_t>::value,
            ...
            struct promote_traits<nil::crypto3::multiprecision::number<Backend1, ExpressionTemplates1>, Arithmetic> {
                using promote_type = nil::crypto3::multiprecision::number<Backend1, ExpressionTemplates1>;
            };
            ...
            template<class Backend1, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates1,
                     class tag, class Arg1, class Arg2, class Arg3, class Arg4>
            struct promote_traits<nil::crypto3::multiprecision::number<Backend1, ExpressionTemplates1>,
                                  nil::crypto3::multiprecision::detail::expression<tag, Arg1, Arg2, Arg3, Arg4>> {
                using number1_t = nil::crypto3::multiprecision::number<Backend1, ExpressionTemplates1>;
                using expression_type = nil::crypto3::multiprecision::detail::expression<tag, Arg1, Arg2, Arg3, Arg4>;
            ...
            struct promote_traits<nil::crypto3::multiprecision::detail::expression<tag, Arg1, Arg2, Arg3, Arg4>,
                ...
                using expression1_t = nil::crypto3::multiprecision::detail::expression<tag, Arg1, Arg2, Arg3, Arg4>;
