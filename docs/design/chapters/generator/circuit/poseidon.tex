    ...
    \begin{table}[H]
        \resizebox{\textwidth}{!}{
            \begin{tabular}{llllllllllllllll}
                ...
                $i$ & $T_{0, 0}$ & $T_{0, 1}$ & $T_{0, 2}$ & 
                $T_{1, 0}$ & $T_{1, 1}$ & $T_{1, 2}$ & $T_{2, 0}$ & $T_{2, 1}$ & $T_{2, 2}$ & $T_{3, 0}$ & $T_{3, 1}$ & $T_{3, 2}$ & $T_{4, 0}$ & $T_{4, 1}$ & $T_{4, 2}$ \\
                $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ \\
                $i + 10$ & $T_{50, 0}$ & $T_{50, 1}$ & $T_{50, 2}$ &
                $T_{51, 0}$ & $T_{51, 1}$ & $T_{51, 2}$ & $T_{52, 0}$ & $T_{52, 1}$ & $T_{52, 2}$ & $T_{53, 0}$ & $T_{53, 1}$ & $T_{53, 2}$ & $T_{54, 0}$ & $T_{54, 1}$ & $T_{54, 2}$ \\
