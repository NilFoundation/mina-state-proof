...
library redshift_proof_map_parser_calldata {
        ...
        )
    {
        ...
        proof_map.witness_commitments_offset = basic_marshalling_calldata
            .skip_octet_vector_32_be_check(blob, offset);
        // skip witness_commitments
        proof_map.T_commitments_offset = basic_marshalling_calldata
            .skip_vector_of_octet_vectors_32_be_check(
                blob,
                proof_map.witness_commitments_offset
            );
        // skip T_commitments
        proof_map.eval_proof_offset = basic_marshalling_calldata
            .skip_vector_of_octet_vectors_32_be_check(
                blob,
                proof_map.T_commitments_offset
            );
        // skip challenge
        proof_map.eval_proof_witness_offset = basic_marshalling_calldata
            .skip_uint256_be_check(blob, proof_map.eval_proof_offset);
        // skip witness
        proof_map.eval_proof_permutation_offset = lpc_verifier_calldata
            .skip_vector_of_proofs_be_check(
                blob,
                proof_map.eval_proof_witness_offset
            );
        // skip permutation
        proof_map.eval_proof_quotient_offset = lpc_verifier_calldata
            .skip_vector_of_proofs_be_check(
                blob,
                proof_map.eval_proof_permutation_offset
            );
        // skip quotient
        proof_map.eval_proof_id_permutation_offset = lpc_verifier_calldata
            .skip_vector_of_proofs_be_check(
                blob,
                proof_map.eval_proof_quotient_offset
            );
        // skip id_permutation
        proof_map.eval_proof_sigma_permutation_offset = lpc_verifier_calldata
            .skip_vector_of_proofs_be_check(
                blob,
                proof_map.eval_proof_id_permutation_offset
            );
        // skip sigma_permutation
        proof_map.eval_proof_public_input_offset = lpc_verifier_calldata
            .skip_vector_of_proofs_be_check(
                blob,
                proof_map.eval_proof_sigma_permutation_offset
            );
        // skip public_input
        proof_map.eval_proof_constant_offset = lpc_verifier_calldata
            .skip_vector_of_proofs_be_check(
                blob,
                proof_map.eval_proof_public_input_offset
            );
        // skip constant
        proof_map.eval_proof_selector_offset = lpc_verifier_calldata
            .skip_vector_of_proofs_be_check(
                blob,
                proof_map.eval_proof_constant_offset
            );
        // skip selector
        proof_map.eval_proof_special_selectors_offset = lpc_verifier_calldata
            .skip_vector_of_proofs_be_check(
                blob,
        ...
        proof_size =
            lpc_verifier_calldata.skip_vector_of_proofs_be_check(
                blob,
