...
library redshift_verifier {
    ...
    function parse_verify_proof_be(
        ...
        (uint256 local_offset, uint256 local_len) =
        ...
        local_offset = proof_map.eval_proof_id_permutation_offset + basic_marshalling.LENGTH_OCTETS;
        for (uint256 i = 0; i < permutation_argument_params.id_permutation_ptrs.length; i++) {
            permutation_argument_params.id_permutation_ptrs[i] =
                lpc_verifier.get_z_0_ptr_from_proof_be(blob, local_offset);
        ...
        local_offset = proof_map.eval_proof_sigma_permutation_offset + basic_marshalling.LENGTH_OCTETS;
        ...
        // TODO: add transcript(V_P_commitment);
