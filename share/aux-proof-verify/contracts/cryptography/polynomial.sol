...
library PolynomialEval {
    ...
    function compute_lagrange_and_vanishing_fractions(types.verification_key memory vk, uint256 zeta
        ...
        uint256 l_end_denominator;
        uint256 z = zeta;
        // copy input var to prevent stack depth errors
        assembly {
    ...
    function compute_linearised_opening_terms(
        ...
        types.g1_point memory accumulator = compute_grand_product_opening_group_element(proof, vk, challenges, L1_fr);
        types.g1_point memory arithmetic_term = compute_arithmetic_selector_opening_group_element(proof, vk, challenges);
        ...
        types.g1_point memory QRANGE = vk.QRANGE;
        types.g1_point memory QLOGIC = vk.QLOGIC;
    ...
    function compute_batch_opening_commitment(
        types.challenge_transcript memory challenges,
        types.verification_key memory vk,
        types.g1_point memory partial_opening_commitment,
        types.proof memory proof
    ) internal view returns (types.g1_point memory) {
        ...
        // zeta_pow_n is computed in compute_lagrange_and_vanishing_fractions
