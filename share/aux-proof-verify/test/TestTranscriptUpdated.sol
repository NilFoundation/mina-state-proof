...
contract TestTranscript {
    function test_transcript() public {
        ...
        uint256[] memory ch_n1 = new uint256[](5);
        transcript_updated.get_field_challenges(tr_state, ch_n1, bn254_crypto.r_mod);

        uint256[5] memory expected_ch_n1 = [
            662226101649256508861335501384346260158109737217244077368209034823388288134,
            12618297757667089100847824173271171944692736177364121732906933153931760794764,
