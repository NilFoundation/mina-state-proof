...
import "@evm-placeholder-verification/contracts/verifier.sol";
...
import "@evm-placeholder-verification/contracts/cryptography/transcript.sol";
import "@evm-placeholder-verification/contracts/placeholder/proof_map_parser.sol";
import "@evm-placeholder-verification/contracts/placeholder/placeholder_verifier.sol";
import "@evm-placeholder-verification/contracts/placeholder/init_vars.sol";
...
contract MinaStateProof is IVerifier {
    ...
    function verify(bytes calldata blob, uint256[][] calldata init_params,
        ...
        profiling.start_block("mina_base_component::verify");    
        ...
        // 4. prepare evaluaitons of the polynomials that are copy-constrained
        // 5. permutation argument
         profiling.start_block("mina_state_proof::permutation_argument");
        ...
        profiling.end_block();    
        // 7. gate argument specific for circuit
         profiling.start_block("mina_state_proof::gate_argument");
        gate_params.modulus = vars.fri_params.modulus;
        gate_params.theta = transcript.get_field_challenge(vars.tr_state, vars.fri_params.modulus);
        gate_params.eval_proof_witness_offset = vars.proof_map.eval_proof_variable_values_offset;
        gate_params.eval_proof_selector_offset = vars.proof_map.eval_proof_fixed_values_offset;
